...
/**
 *<b> <li>Rule 49: LoopExpr ::= AtomicExpr -> collect ( VariableDeclaration |
 * QueryExpr ) </b>
 */
public class CollectLoopExpr extends Ast implements ILoopExpr {
	...
	public CollectLoopExpr(IToken leftIToken, IToken rightIToken,
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof CollectLoopExpr))
			return false;
		if (!super.equals(o))
			return false;
		CollectLoopExpr other = (CollectLoopExpr) o;
