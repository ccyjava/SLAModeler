...
/**
 *<b> <li>Rule 22: RelationalExpr ::= ArithExpr$LeftArithExpr >
 * ArithExpr$RightArithExpr </b>
 */
public class GreaterExpr extends Ast implements IRelationalExpr {
	...
	public GreaterExpr(IToken leftIToken, IToken rightIToken,
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof GreaterExpr))
			return false;
		if (!super.equals(o))
			return false;
		GreaterExpr other = (GreaterExpr) o;
