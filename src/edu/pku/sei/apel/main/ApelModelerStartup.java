package edu.pku.sei.apel.main;

import org.eclipse.ui.IStartup;

import edu.pku.sei.apel.ctrl.command.ApelCommandFactory;
import edu.pku.sei.apel.main.project.ApelModelerProject;
import edu.pku.sei.apel.main.project.ApelModelerProjectFactory;
import edu.pku.sei.apel.main.provider.ApelContentProvider;
import edu.pku.sei.apel.main.provider.ApelEditorActionProvider;
import edu.pku.sei.apel.main.provider.ApelEditorDropTargetListenerProxyon;
import edu.pku.sei.apel.main.provider.ApelExplorerActionProvider;
import edu.pku.sei.apel.main.provider.ApelLabelProvider;
import edu.pku.sei.apel.main.provider.ApelViewerDropAdapterProxyon;
