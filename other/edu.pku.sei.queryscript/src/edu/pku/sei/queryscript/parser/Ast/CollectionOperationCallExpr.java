...
/**
 *<b> <li>Rule 43: ModelPropertyExpr ::= AtomicExpr -> SimpleName (
 * ArgumentsExpr ) </b>
 */
public class CollectionOperationCallExpr extends Ast implements
		IModelPropertyExpr {
	...
	public CollectionOperationCallExpr(IToken leftIToken, IToken rightIToken,
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof CollectionOperationCallExpr))
			return false;
		if (!super.equals(o))
			return false;
		CollectionOperationCallExpr other = (CollectionOperationCallExpr) o;
