...
public class GMPConst {

	// Strings for model elements
	public static final String __TUPLEELEMENT__ = "Tuple";
	
	// Strings for model element attributes
	public static final String MODEL_NAME = "name";
	public static final String MODEL_DIAGRAMS = "diagrams";
	public static final String MODEL_ROOTELEMENTS = "namespaces";
	public static final String MODEL_ALLTUPLES = "tuples";
	public static final String ELEMENT_ID = "xmi:id";
	public static final String ELEMENT_MODEL = "model";
	public static final String ELEMENT_CONTAINER = "container";
	
	public static final String TUPLE_MODELELEMENT = "modelElement";
	public static final String TUPLE_SHAPEELEMENT = "shapeElement";
	
	// Strings for shape elements
	public static final String __BENDPOINT__ = "GMPBendPoint";
	public static final String __DIAGRAM__ = "GMPDiagram";
	public static final String __LINK__ = "GMPLink";
	public static final String __NODE__ = "GMPNode";
	public static final String __SHAPEELEMENT__ = "ShapeElement";
	public static final String __REFERENCE_NODE__ = "GMPReferenceNode";
	public static final String __LOCATION_MANAGER__ = "LocationManager";
	public static final String __CUSTOME_LOCATOR_ADAPTER__ = "CustomerLocatorAdapter";
	public static final String __PORT_LOCATOR_ADAPTER__ = "PortLocatorAdapter";
	public static final String __PIN_LOCATOR_ADAPTER__ = "PinLocatorAdapter";
	public static final String __HANDLER_LOCATOR__ = "HandlerLocator";
	public static final String __COMPOUND_NODE__ = "CompoundNode";

	// Strings for shape element attributes
	public static final String SHAPEELEMENT_PARENT = "parent";
	public static final String SHAPECONTAINER_SUBNODES = "subNodes";
	...
	public static final String NODE_LINECOLOR = "lineColor";
