 ...
 */
/* package */
public class  GMPPropertySheetViewer  extends Viewer {
    ...
    private static String MISCELLANEOUS_CATEGORY_NAME = "Default";
     ...
     *            the parent control
     */
    public GMPPropertySheetViewer(Composite parent) {
